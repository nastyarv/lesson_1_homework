...
### Баг-репорт «Поле First Name при регистрации пустое»
1. Предусловия: 
...
### Баг-репорт «Поле First Name при регистрации заполнено только пробелами»
1. Предусловия: 
...
### Баг-репорт «В поле First Name при регистрации введено имя длины, большей максимально разрешенной»
1. Предусловия: 
