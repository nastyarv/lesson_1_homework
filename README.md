...
### Баг-репорт «Система не выдает ошибку и успешно завершает регистрацию, когда поле First Name пустое»
1. Предусловия: 
...
### Баг-репорт «Система не выдает ошибку и успешно завершает регистрацию, когда поле First Name заполнено только пробелами»
1. Предусловия: 
...
### Баг-репорт «Система не выдает ошибку и успешно завершает регистрацию, когда в поле First Name введено имя, длиной больше максимально разрешенной»
1. Предусловия: 
