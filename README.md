...
- Заполнить поля Country, Email, Last Name соответственно Norway, me@whatyouknow.com, Gheorghe
2. Шаги:
- Поле First Name оставить пустым
- Нажать кнопку Submit, то есть отправить запрос на обработку 
3. Ожидаемый результат:
- Сообщение об ошибке «Empty values»
- Отказ в регистрации
